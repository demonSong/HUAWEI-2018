...
public class GBM {
    ...
    public void fit(List<Instance> train,
    				List<Instance> valid,
        ...
        TrainData trainset = new TrainData(train);
        ...
        if(valid == null || valid.size() == 0){
            ...
            do_validation = true;
            valset = new ValidationData(valid);
...
//                                    new Object[]{i,eval_metric,best_val_metric});
    ...
    public double predict(Instance instance) {
    	float[][] feature = new float[1][instance.getFeature_dim()];
    	for (int i = 0; i < instance.getFeature_dim(); ++i) {
    		feature[0][i] = (float) instance.X[i];
    	}
    	return this.predict(feature)[0];
    }
